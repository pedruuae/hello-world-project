  ...
  return (
    <main id="top" className="site-shell">
      <nav className="nav container">
        ...
        <a className="button button-small" href="#preco">Baixar LovaRpm <ArrowRight size={15}/></a>
      </nav>
      ...
      <section className="hero container">
        ...
        <div className="hero-actions"><a className="button button-primary" href="#preco">Baixar LovaRpm <ArrowRight size={18}/></a><a className="button button-ghost" href="#recursos">Ver recursos</a></div>
      ...
      <section id="preco" className="pricing-section section container">
        ...
        <div className="pricing-card">
          ...
          <a className="button button-primary price-button" href="#download">Baixar LovaRpm <ArrowRight size={18}/></a>
      ...
      <section id="download" className="final-cta container"><div className="cta-glow"/><span>PRONTO PARA ACELERAR?</span><h2>Seu projeto não precisa<br/>de mais um prompt gigante.</h2><p>Leve o LovaRpm para o seu fluxo e construa com mais ritmo.</p><a className="button button-primary" href="#preco">Baixar LovaRpm <ArrowRight size={18}/></a></section>
